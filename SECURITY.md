...
Replace this section with the supported versions for `fixturepin`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `fixturepin` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in fixturepin.
